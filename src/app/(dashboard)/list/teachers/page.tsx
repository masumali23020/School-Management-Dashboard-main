...
const TeacherListPage = async ({
  ...
  // IMPORTANT: Add schoolId filter to only show teachers from current school
  const query: Prisma.EmployeeWhereInput = {
    role: UserRole.TEACHER,
    schoolId: Number(schoolId), // 🔥 This is the key change - filter by school
  };
  ...
  console.log(`Found ${count} teachers for school ${schoolId}`); // Debug log
