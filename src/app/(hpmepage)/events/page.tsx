    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="bg-[#1a365d] text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold">সকল ইভেন্ট</h1>
          ...
          {upcoming.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {upcoming.map((event, idx) => {
                ...
                return (
                  <article key={event.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all hover:-translate-y-0.5 group">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {past.map((event, idx) => {
                const c = colors[idx % colors.length];
                return (
                  <article key={event.id} className="bg-white/60 rounded-2xl border border-gray-100 overflow-hidden opacity-75 hover:opacity-100 transition-opacity">
