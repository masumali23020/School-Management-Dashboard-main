// app/[schoolSlug]/admission/page.tsx
...
export default async function AdmissionPage({ params }: { params: { schoolSlug: string } }) {
  ...
  // ২. স্কুল সেটিংস এবং ক্লাস ডাটা ফেচিং
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
              ...
              <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-between">
                ...
                <Link
                  href={`/${params.schoolSlug}/contact`}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 space-y-20">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {classes.map((cls) => {
              ...
              const statusText =
                pct >= 90 ? "প্রায় পূর্ণ" : pct >= 70 ? "সীমিত আসন" : "আসন আছে";
              const statusBadge =
                pct >= 90
                    ...
                    <div className="bg-slate-50 rounded-xl py-2.5">
                      <p
                        className={`font-extrabold text-lg ${
                          available === 0 ? "text-rose-500" : "text-emerald-600"
                        }`}
                      >
                        {available}
                      </p>
                        ...
                        {cls.feeStructures.map((fs) => (
                          <div key={fs.id} className="flex justify-between text-xs">
                            ...
                            <span className="font-bold text-[#1a365d]">
                              ৳ {fs.amount.toLocaleString("bn-BD")}
                            </span>
                          </div>
                        ))}
                      </div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    >
                      ...
                      <span className="font-bold text-white text-sm bg-white/10 px-3 py-1 rounded-full">
                        {d.date}
                      </span>
                    </div>
                  ))}
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 30% 50%, #38bdf8 0%, transparent 50%)",
            }}
          />
          <div className="relative">
